...
func (x *ReqProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqProgress) ProtoMessage() {}

func (x *ReqProgress) ProtoReflect() protoreflect.Message {
	mi := &file_progress_proto_msgTypes[0]
...
// Deprecated: Use ReqProgress.ProtoReflect.Descriptor instead.
func (*ReqProgress) Descriptor() ([]byte, []int) {
	return file_progress_proto_rawDescGZIP(), []int{0}
}

func (x *ReqProgress) GetChapter() int32 {
	if x != nil {
		return x.Chapter
	}
	return 0
...
func (x *ReqProgress) GetSection() int32 {
	if x != nil {
		return x.Section
	}
	return 0
...
func (x *RetProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RetProgress) ProtoMessage() {}

func (x *RetProgress) ProtoReflect() protoreflect.Message {
	mi := &file_progress_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RetProgress.ProtoReflect.Descriptor instead.
func (*RetProgress) Descriptor() ([]byte, []int) {
	return file_progress_proto_rawDescGZIP(), []int{1}
}

func (x *RetProgress) GetChapter() int32 {
	if x != nil {
		return x.Chapter
	}
	return 0
...
func (x *RetProgress) GetSection() int32 {
	if x != nil {
		return x.Section
	}
	return 0
...
var file_progress_proto_rawDesc = []byte{
	...
	,
...
var file_progress_proto_goTypes = []interface{}{
	(*ReqProgress)(nil), // 0: protocol.ReqProgress
	(*RetProgress)(nil), // 1: protocol.RetProgress
}
