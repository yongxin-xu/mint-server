...
type SrvResponse struct {
	...
	Error uint32   `protobuf:"varint,1,opt,name=Error,proto3" json:"Error,omitempty"` // Successful if Error = 0, otherwise failed
	Info  string   `protobuf:"bytes,2,opt,name=Info,proto3" json:"Info,omitempty"`    // Send Information to Clients
	Au    *AppUser `protobuf:"bytes,3,opt,name=Au,proto3" json:"Au,omitempty"`        // AppUser information, client can get (name, id)
}

func (x *SrvResponse) Reset() {
	*x = SrvResponse{}
...
func (x *SrvResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SrvResponse) ProtoMessage() {}

func (x *SrvResponse) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[0]
...
// Deprecated: Use SrvResponse.ProtoReflect.Descriptor instead.
func (*SrvResponse) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{0}
}

func (x *SrvResponse) GetError() uint32 {
	if x != nil {
		return x.Error
	}
	return 0
...
func (x *SrvResponse) GetInfo() string {
	if x != nil {
		return x.Info
	}
	return ""
...
func (x *SrvResponse) GetAu() *AppUser {
	if x != nil {
		return x.Au
	}
	return nil
...
var file_response_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x0b, 0x53, 0x72, 0x76, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x49, 0x6e,
	0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20,
	0x0a, 0x02, 0x41, 0x75, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x68, 0x61, 0x6e,
	0x64, 0x6c, 0x65, 0x72, 0x2e, 0x41, 0x70, 0x70, 0x55, 0x73, 0x65, 0x72, 0x52, 0x02, 0x41, 0x75,
...
var file_response_proto_goTypes = []interface{}{
	(*SrvResponse)(nil), // 0: handler.SrvResponse
	(*AppUser)(nil),     // 1: handler.AppUser
}
var file_response_proto_depIdxs = []int32{
	1, // 0: handler.SrvResponse.Au:type_name -> handler.AppUser
