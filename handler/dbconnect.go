...
//		3. error
func signUpTry(account string, name string, password string) (ServerReturnCode, uint32, error) {
	...
	return ServerReturnCode_OK, uint32(ret_id), nil
}
...
//		1. status of the result
//		2. error
func signInTry(account string, id uint32, password string) (ServerReturnCode, error) {
